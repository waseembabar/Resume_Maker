        ...
        <div class="mb-6">
          ...
          <div class="w-full bg-gray-200 h-2 rounded-full overflow-hidden">
            <div
              ...
              :style="{ width: ((store.activeTabIndex + 1) / steps.length) * 100 + '%' }"
            ></div>
          </div>
  ...
  >
    ...
    >
     ...
     <UCard class="mt-6 shadow-sm border-gray-200">
      ...
      <div class="sticky top-6 h-[calc(100vh-3rem)] overflow-auto bg-white dark:bg-gray-900 border rounded-2xl p-6 shadow-lg">
